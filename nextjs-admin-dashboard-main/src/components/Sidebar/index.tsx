    ...
    menuItems: [
      {
        icon: (
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M3 8.976C3 4.05476 4.05476 3 8.976 3H15.024C19.9452 3 21 4.05476 21 8.976V15.024C21 19.9452 19.9452 21 15.024 21H8.976C4.05476 21 3 19.9452 3 15.024V8.976Z" stroke="gray" stroke-width="2"/>
            <path d="M21 9L3 9" stroke="gray" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M9 21L9 9" stroke="gray" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        ),
        label: "Dashboard",
        route: "/",
      ...
      {
        icon: (
          <svg fill="gray" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        route: "#",
        children: [
          { label: "Upload Bills", route: "/calendar" },
          { label: "Search Bills", route: "/calendar" },
        ],
      },
      {
        icon: (
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle opacity="0.5" cx="12" cy="12" r="10" stroke="gray" stroke-width="1.5"/>
            <path d="M12 6V18" stroke="gray" stroke-width="1.5" stroke-linecap="round"/>
            <path d="M15 9.5C15 8.11929 13.6569 7 12 7C10.3431 7 9 8.11929 9 9.5C9 10.8807 10.3431 12 12 12C13.6569 12 15 13.1193 15 14.5C15 15.8807 13.6569 17 12 17C10.3431 17 9 15.8807 9 14.5" stroke="gray" stroke-width="1.5" stroke-linecap="round"/>
          </svg>
        ),
      ...
      {
        icon: (
          <svg fill="gray" width="24" height="24" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
      ...
      {
        icon: (
          <svg width="24" height="24" fill="#9ca3af" viewBox="0 0 96 96" xmlns="http://www.w3.org/2000/svg">
